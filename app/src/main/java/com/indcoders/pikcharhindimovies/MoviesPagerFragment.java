 ...
 * {@link MoviesPagerFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MoviesPagerFragment#newInstance} factory method to
...
public class MoviesPagerFragment extends Fragment {
     ...
     * @return A new instance of fragment MoviesPagerFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MoviesPagerFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_movies_pager, container, false);

        pager = (ViewPager) v.findViewById(R.id.viewPager);
        pager.setAdapter(new MoviesPagerAdapter(getChildFragmentManager()));
